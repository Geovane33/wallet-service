            ...
            (new JavaTimeModule())
                .addDeserializer(LocalDateTime.class,
                    new LocalDateTimeDeserializer(
                        DateTimeFormatter.ofPattern(DATE_TIME_FORMATTER_WITH_MILLISECONDS)))
                .addSerializer(LocalDateTime.class,
                    new LocalDateTimeSerializer(
                        DateTimeFormatter.ofPattern(DATE_TIME_FORMATTER_WITH_MILLISECONDS)))
                .addSerializer(YearMonth.class,
                    new YearMonthSerializer(
                        DateTimeFormatter.ofPattern(DATE_TIME_FORMAT_YEAR_MONTH)))
                .addDeserializer(YearMonth.class,
                    new YearMonthDeserializer(
                        DateTimeFormatter.ofPattern(DATE_TIME_FORMAT_YEAR_MONTH)))
                .addDeserializer(LocalDate.class,
                    new LocalDateDeserializer(
                        DateTimeFormatter.ofPattern(DATE_TIME_FORMATTER_YEAR_MONTH_DAY)))
